...
In order to test my highway implementation I wrote the \texttt{unittest} based \path{test/highway_test.py}. This test class uses a helper method in the \texttt{Highway} instance to set the weights to know values.
